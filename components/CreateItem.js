...
class CreateItem extends Component {
    ...
    uploadFile = async (e) => {
        ...
        const res = await fetch('https://api.cloudinary.com/v1_1/svetzayats/image/upload', {
            method: 'POST', 
            body: data
        });
                ...
                {(createItem, { loading, error}) => (
                    ...
                    <label htmlFor="file">
                        ...
                        <label htmlFor="description">
                            Description
                            <textarea id="description" name="description" placeholder="Description" required value={this.state.description} 
                            onChange={this.handleChange}/>
                        </label>
